...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bit " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"54.92.85.230", "54.92.85.230"},
    {"54.179.160.116", "54.179.160.116"},
    {NULL, NULL}
};
...
// '{:02X}{:02X}{:02X}{:02X}'.format(*map(int, "54.92.85.230".split('.')))
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bit is probably already running."), addrBind.ToString().c_str());
        else
